  ...
  try {
    ...
    const sendOnce = () => send(GENERATION_URL, {
      ...
      body: JSON.stringify({
        ...
        generationConfig:{responseMimeType:"application/json",responseSchema,maxOutputTokens:6000,thinkingConfig:{thinkingLevel:"minimal"}},
      }),
      signal,
    });
